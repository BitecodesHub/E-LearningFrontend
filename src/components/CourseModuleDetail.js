                ...
                <div key={index} className="mt-8 space-y-6">
                  <div className="flex flex-col items-center">
                    ...
                    {module.content[index] && (
                      <p className="text-lg mt-4 text-gray-700 text-left w-full">{module.content[index]}</p>
                    )}
                  </div>
                </div>
              ))
              ...
              <div className="mt-8">
                ...
                <ul className="list-disc ml-6 text-gray-700 space-y-2">
                  {module.content?.map((item, index) => (
                    <li key={index} className="transition-all duration-300 ease-in-out hover:text-blue-600">{item}</li>
                  ))}
                </ul>
              </div>
            )}
